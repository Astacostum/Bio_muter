"""
Author: VILLAIN MUSIC
User: https://t.me/iamakki001
...
async def start_handler(client: Client, message):
    ...
    user = message.from_user.mention  # <--- user ka name add ho jayega
    bot = await client.get_me()
    add_url = f"https://t.me/{bot.username}?startgroup=true"

    caption = (
        f"👋 ʜᴇʟʟᴏ, {user} ɪ'ᴍ ʏᴏᴜʀ ʙɪᴏ ᴍᴜᴛᴇ ʙᴏᴛ.\n\n"
        "🚨 ɪ ᴀᴜᴛᴏ-ᴅᴇᴛᴇᴄᴛ ʟɪɴᴋꜱ ɪɴ ᴜsᴇʀ ʙɪᴏs.\n"
        "⚠️ ᴇᴀᴄʜ ᴛɪᴍᴇ ᴀ ᴡᴀʀɴɪɴɢ ɪs ɪssᴜᴇᴅ.\n"
        "🔒 3 ᴡᴀʀɴs = ᴀᴜᴛᴏ ʙᴀɴ / ᴍᴜᴛᴇ.\n\n"
        "⭐ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ & ɢʀᴀɴᴛ ᴀᴅᴍɪɴ + ʀᴇsᴛʀɪᴄᴛ ʀɪɢʜᴛꜱ.\n"
        "🛡️ ɪ'ʟʟ ᴋᴇᴇᴘ ʏᴏᴜʀ ɢʀᴏᴜᴘ sᴀꜰᴇ ꜰʀᴏᴍ ʟɪɴᴋ ᴜsᴇʀs.\n"
        "🔔 ᴊᴏɪɴ sᴜᴘᴘᴏʀᴛ ꜰᴏʀ ᴍᴏʀᴇ ᴜᴘᴅᴀᴛᴇs."
    )

    kb = InlineKeyboardMarkup([
        [InlineKeyboardButton("• ʌᴅᴅ ϻє вᴧʙʏ •", url=add_url)],
        [
            InlineKeyboardButton("💬 sυᴘᴘσʀᴛ", url="https://t.me/iamvillain77"),
            InlineKeyboardButton("🪄 υᴘᴅᴧᴛєs", url="https://t.me/iamvillain77")
        ],
        [InlineKeyboardButton("👑 ❍ᴡηєʀ", url="https://t.me/iamakki001")]
    ])

    await client.send_photo(
        chat_id,
        photo="https://i.ibb.co/CLfzBw8/file-395.jpg",
        caption=caption,
        reply_markup=kb
    )
